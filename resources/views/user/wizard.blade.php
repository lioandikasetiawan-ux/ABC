        ...
        <div class="mb-8 relative">
            ...
            <div class="flex justify-between overflow-x-auto pb-2 gap-1">
                @for ($i = 1; $i <= 11; $i++)
                    ...
                    @if ($i < 11)
                        <div class="flex-1 h-0.5 mt-4 {{ $isCompleted ? 'bg-emerald-500' : 'bg-slate-200' }}"></div>
                    @endif
                @endfor
            </div>
        </div>
        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                ...
                <div
                    ...
                    {{-- Progress --}}
                    @php
                        $totalCompleted = $paket->submissions
                ...
                @if ($errors->any())
                    <div class="mx-6 mt-6 p-4 bg-rose-50 border-l-4 border-rose-500 rounded-r-lg">
                        <div class="flex items-start gap-3">
                            <div class="w-6 h-6 rounded-lg bg-rose-100 flex items-center justify-center flex-shrink-0">
                ...
                <form action="{{ route('user.wizard.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    {{ $errors->has('file_upload') ? 'border-rose-300 bg-rose-50/30' : 'border-slate-200 hover:border-indigo-400' }}">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="mt-4">
                                <div
                                    class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg text-xs font-medium shadow-sm shadow-indigo-200 pointer-events-none">
                                    Pilih File
                                </div>
                            </div>
                        </div>
